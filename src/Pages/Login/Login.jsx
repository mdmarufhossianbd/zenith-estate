...
const Login = () => {
    ...
    return (
        <div className="bg-[#000] bg-[url('https://i.ibb.co/D4p1Y1x/real-state-banner-2.png')] bg-blend-screen bg-cover bg-no-repeat lg:pt-[7%] md:py-[12%] py-[10%]">
                ...
                <form onSubmit={handlelogin} >
                    <div className="flex flex-col gap-4 mb-8">
                        ...
                        <div className="relative">
                            <input className="bg-[#100a5500] w-full border-b-2 p-3 text-lg text-white placeholder:text-white rounded-md" name="password" type={showPassword ? "text" : "password"} placeholder="Password" required/>
